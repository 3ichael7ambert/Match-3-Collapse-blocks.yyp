/// @description glr_directional_custom_create(sprite, subimage, sprite_shadow, subimage_shadow, x, y, zdepth, xscale, yscale, rotation)
/// @param sprite
/// @param  subimage
/// @param  sprite_shadow
...
/// @param  yscale
/// @param  rotation
function glr_directional_custom_create(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9) {
