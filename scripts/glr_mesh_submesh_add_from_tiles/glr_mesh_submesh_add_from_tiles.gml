/// @description glr_mesh_submesh_add_from_tiles(mesh, layer, xoffset, yoffset)
/// @param mesh
/// @param  layer
/// @param  xoffset
/// @param  yoffset
function glr_mesh_submesh_add_from_tiles(argument0, argument1, argument2, argument3) {
