/// @description glr_shadowdepth_create(sprite, subimage, x, y, zdepth, xscale, yscale, rotation)
/// @param sprite
/// @param  subimage
/// @param  x
/// @param  y
...
/// @param  yscale
/// @param  rotation
function glr_shadowdepth_create(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7) {
