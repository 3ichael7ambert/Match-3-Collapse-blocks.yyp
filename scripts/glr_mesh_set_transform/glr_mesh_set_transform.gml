/// @description glr_mesh_set_transform(meshid, x, y, xscale, yscale, rotation)
/// @param meshid
/// @param  x
/// @param  y
/// @param  xscale
/// @param  yscale
/// @param  rotation
function glr_mesh_set_transform(argument0, argument1, argument2, argument3, argument4, argument5) {
