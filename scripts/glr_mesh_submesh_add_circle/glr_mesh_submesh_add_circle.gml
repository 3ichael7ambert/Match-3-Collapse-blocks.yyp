/// @description glr_mesh_submesh_add_circle(mesh, radius, num_vertices, xoffset, yoffset);
/// @param mesh
/// @param  radius
/// @param  num_vertices
/// @param  xoffset
/// @param  yoffset
function glr_mesh_submesh_add_circle(argument0, argument1, argument2, argument3, argument4) {
