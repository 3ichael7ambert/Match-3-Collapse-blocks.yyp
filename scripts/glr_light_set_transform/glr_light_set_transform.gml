/// @description glr_light_set_transform(light, x, y, xscale, yscale, rotation)
/// @param light
/// @param  x
/// @param  y
/// @param  xscale
/// @param  yscale
/// @param  rotation
function glr_light_set_transform(argument0, argument1, argument2, argument3, argument4, argument5) {
