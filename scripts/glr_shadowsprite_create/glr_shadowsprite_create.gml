/// @description glr_shadowsprite_create(sprite, subimage, x, y, xscale, yscale, rotation, static)
/// @param sprite
/// @param  subimage
/// @param  x
/// @param  y
...
/// @param  rotation
/// @param  static
function glr_shadowsprite_create(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7) {
