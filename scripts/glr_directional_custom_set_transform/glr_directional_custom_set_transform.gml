/// @description glr_directional_custom_set_transform(id, x, y, xscale, yscale, rotation)
/// @param id
/// @param  x
/// @param  y
/// @param  xscale
/// @param  yscale
/// @param  rotation
function glr_directional_custom_set_transform(argument0, argument1, argument2, argument3, argument4, argument5) {
