/// @description glr_mesh_submesh_add_list(mesh, vertices_ds_list, xoffset, yoffset);
/// @param mesh
/// @param  vertices_ds_list
/// @param  xoffset
/// @param  yoffset
function glr_mesh_submesh_add_list(argument0, argument1, argument2, argument3) {
