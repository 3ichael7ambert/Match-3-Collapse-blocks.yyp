/// @description glr_mesh_submesh_add_box_from_sprite(mesh, sprite, xoffset, yoffset);
/// @param mesh
/// @param  sprite
/// @param  xoffset
/// @param  yoffset
function glr_mesh_submesh_add_box_from_sprite(argument0, argument1, argument2, argument3) {
