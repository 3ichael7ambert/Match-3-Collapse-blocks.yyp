/// @description glr_occlusion_create(sprite, subimage, x, y, xscale, yscale, rotation);
/// @param sprite
/// @param  subimage
/// @param  x
/// @param  y
...
/// @param  yscale
/// @param  rotation
function glr_occlusion_create(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
