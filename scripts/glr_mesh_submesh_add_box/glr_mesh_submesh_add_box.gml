/// @description glr_mesh_submesh_add_box(mesh, width, height, xoffset, yoffset);
/// @param mesh
/// @param  width
/// @param  height
/// @param  xoffset
/// @param  yoffset
function glr_mesh_submesh_add_box(argument0, argument1, argument2, argument3, argument4) {
